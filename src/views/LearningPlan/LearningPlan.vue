<template>
  <div class="com-container">
    ...
    <view-box minus="87px" v-if="selectedTab === 'active'">
      <p v-if="selectedTab === 'active' && stage_select_id == stage.id" class="stageTitle">当前学习阶段：{{ stage.catalog_name}}</p>
      <p v-else class="stageTitle">当前查看阶段：{{ stage.catalog_name }}</p>
      <div class="articleList-container">
        <table class="articleList">
          ...
          <tr>
            ...
            <td></td>
            <td>
              <div class="toArticleBtn" @click="toExam">考试</div>
            </td>
          </tr>
        </table>
      </div>
      <div style="width: 100%;margin-top: 20px; display: flex;justify-content: center;">
        <table class="near">
          <tr>
            <td v-if="last_stage == null">
              <p>上一阶段</p>
              <span>没有了</span>
            </td>
            <td v-else @click="lastStage(last_stage.id)">
              <p>上一阶段</p>
              <span>{{last_stage.catalog_name}}</span>
            </td>
            <td v-if="next_stage == null">
              <p>下一阶段</p>
              <span>没有了</span>
            </td>
            <td v-else @click="nextStage(next_stage.id)">
              <p>下一阶段</p>
              <span>{{next_stage.catalog_name}}</span>
            </td>
          </tr>
        </table>
      </div>
